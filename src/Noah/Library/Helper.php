...
class Helper
{
    ...
    /**
     * Remove NoahWallet prefix from address or transaction
     *
     * @param string $string
     * @return string
     */
    ...
    {
        return self::removePrefix($string, NoahPrefix::ADDRESS);
    }
    ...
    /**
     * Add NoahWallet prefix to address or transaction
     *
     * @param string $string
     * @return string
     */
    ...
    {
        return NoahPrefix::ADDRESS . $string;
    }
